...
def affiche_image(nom_image,dest_bas_gauche, source_bas_gauche = None, source_haut_droit = None):
    """
        ...
        source_bas_gauche et source_haut_droit correspondent aux coins du rectangle dans l'image à afficher (pour afficher un morceau seulement).
...
def last_clic():
    """ si le bouton gauche de la souris a été relaché depuis le dernier appel à last_clic(),
        ...
        A utiliser avec précaution :
            - le dernier clic effectué peut être "vieux", il peut être judicieux de faire un appel préventif à last_clic pour vider les anciens clics
...
def get_fleches():
    """
        renvoie un Point p contenant
            en abscisse le nombre d'appui sur les fleches gauche et droite (-1 par appui sur la fleche gauche, +1 sur la fleche droite)
...
def touche_enfoncee(touche):
    """
        ...
        touche est une chaine de caractère :
            ...
            le pavé numérique 'K_KP0', 'K_KP1', etc et 'K_KP_ENTER' (entree), 'K_KP_PLUS', 'K_KP_MINUS', 'K_KP_MULTIPLY', 'K_KP_DIVIDE' (opérations) et 'K_KP_PERIOD' (point)
    """
